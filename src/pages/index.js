  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-dm text-lg md:text-xl mb-10">
  ...
  const services = [
    {
      ...
      description:
        "Reemplazamos el aceite del motor con la viscosidad y marca adecuadas.",
    },
    {
      title: "Filtros completos",
      img: "/images/filtros.jpg",
      description:
        "Sustituimos filtros de aceite, aire, habitáculo y combustible.",
    },
    {
      title: "Limpieza de radiador",
      img: "/images/radiador.jpg",
      description:
        "Eliminamos sedimentos y mejoramos la circulación del refrigerante.",
    },
  ];
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Service completo para tu auto: cambio de aceite y filtros en La Plata desde 1984."
        />
      </Head>
      ...
      <section id="nosotros" className="bg-slate-200 py-20 text-center">
        ...
        <p className="max-w-2xl mx-auto font-dm">
          Desde 1984 en La Plata, ofreciendo servicio responsable y
          personalizado con las mejores marcas.
        </p>
      </section>
      ...
      <section id="testimonios" className="bg-slate-300 py-20 text-center">
        ...
        <p className="italic">
          Aquí mostraremos las últimas reseñas de Google.
        </p>
      </section>
      ...
      <footer className="bg-black text-white py-10 text-center">
        <p className="font-dm">
          © {new Date().getFullYear()} Lubricentro 72 — La Plata
        </p>
      </footer>
    </>
  );
